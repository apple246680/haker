...
local CombatWindow = GuiLibrary.CreateWindow({["Name"] = "戰鬥"})
local ExploitsWindow = GuiLibrary.CreateWindow({["Name"] = "漏洞利用"})
local MiscellaneousWindow = GuiLibrary.CreateWindow({["Name"] = "各種各樣的"})
local MovementWindow = GuiLibrary.CreateWindow({["Name"] = "移動"})
local RenderWindow = GuiLibrary.CreateWindow({["Name"] = "使成為"})
local WorldWindow = GuiLibrary.CreateWindow({["Name"] = "世界"})
local OtherWindow = GuiLibrary.CreateWindow({["Name"] = "其他"})
